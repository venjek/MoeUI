...
TransmogTokens.calculateNeededText = function(relatedItems, itemID, bonus)
	...
	if #needed > 0 then
		...
		if #needed > 1 then
			message = message .. string.format ("Can be exchanged for %d appearances you need.", #needed);
		else
			message = message .. "Can be exchanged for 1 appearance you need.";
		end
		...
		message = GRAY .. "Can be exchanged for appearances you don't need.";
	end
