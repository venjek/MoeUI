...
L["SUGGESTIONS_HELP"] = "Les hauts faits suggérés sont affichés ici en fonction de votre localisation. Sont également listés tous les hauts faits qui vous ont été rappelés par une infobulle dans les 2 dernières minutes ou qui ont une alarme qui s'est déclenchée récemment." -- Needs review
...
L["SUGGESTIONS_HELP"] = "根據你目前的位置建議追蹤成就。" -- Needs review
...
-- L["SUGGESTIONS_ZONERENAME_DALARAN_BROKENISLES"] = ""
-- L["SUGGESTIONS_ZONERENAME_DALARAN_NORTHREND"] = ""
L["TAB_HELP"] = "|cffffffffCtrl + 點選|r 所選成就會跳轉到該成就的頁面.|n|n |cffffffff藍色背景|r表示此成就是你還沒有完成前續內容的系列成就部分.|n|n |cffffffff紅色背景|r表示此成就無法在你當前人物的標準成就界面中找到,因為這是陣營專屬成就,或者是你尚未取得的『光輝事跡』成就." -- Needs review
L["TAB_SORT"] = "類型:"
...
L["SUGGESTIONS_HELP"] = "Предполагаемые достижения, указанные здесь, основаны на вашем текущем местоположении. Также здесь могут находиться достижения, объекты к которым вы повстречали за последние 2 минуты." -- Needs review
...
L["SUGGESTIONS_HELP"] = "추천된 업적은 플레이어의 현재 위치를 기준하여 표시됩니다. 또한 2분전까지 툴팁으로 알려주었던 업적도 포함됩니다." -- Needs review
...
-- L["SUGGESTIONS_ZONERENAME_DALARAN_BROKENISLES"] = ""
-- L["SUGGESTIONS_ZONERENAME_DALARAN_NORTHREND"] = ""
L["TAB_HELP"] = "|cffffffff컨트롤+좌클릭|r으로 기본 UI의 해당 업적으로 이동할 수 있습니다.|n|n|cffffffff푸른 바탕|r은 완료되지 않은 업적 세트의 일부를 의미합니다.|n|n|cffffffff붉은 바탕|r은 반대 평판 등의 이유로 이 캐릭터의 기본 UI에는 존재하지 않는 업적을 의미합니다.|n|n|cffffffff녹색 바탕|r은 이 업적과 관련된 알림 정보가 최근 툴팁에 표시되었음을 의미합니다." -- Needs review
L["TAB_SORT"] = "정렬 기준:"
...
L["SUGGESTIONS_HELP"] = "Las sugerencias de logros aquí listados se basan en tu ubicación actual. También se lista cualquier logro del cual se te ha mostrado un tooltip recordatorio en los últimos dos minutos." -- Needs review
...
L["SUGGESTIONS_HELP"] = "As conquistas sugeridas são listadas aqui de acordo com a sua localização. Também são listadas as conquistas das quais você foi lembrado com uma dica de tela nos últimos 2 minutos ou cujo cronômetro começou recentemente." -- Needs review
...
-- L["SUGGESTIONS_ZONERENAME_DALARAN_BROKENISLES"] = ""
-- L["SUGGESTIONS_ZONERENAME_DALARAN_NORTHREND"] = ""
L["TAB_HELP"] = "|cffffffffCtrl-clique|r em uma conquista para ir ao seu lugar na página padrão.|n|nUm |cfffffffffundo azul|r significa que é parte de uma série da qual você não completou um passo anterior.|n|nUm |cfffffffffundo vermelho|r significa que não pode ser encontrada na página padrão para este personagem por ser exclusiva à facção oposta ou por ser uma Proeza Memorável não conquistada.|n|nUm |cfffffffffundo verde|r significa que um lembrete desta conquista foi exibido numa dica de tela recentemente ou tem um cronômetro que começou recentemente." -- Needs review
