...
L["Apply"] = "Appliquer"
L["Apply theme"] = "Application d'un thème"
L["Ask"] = "Demander"
L["Attack"] = "Attaque"
...
L["Autostop"] = "Arrêter en cours de wipe"
L["Autostop description"] = "Arrête automatiquement le segment actuel une fois que la moitié des membres de votre raid est mort."
-- L["Average"] = ""
...
L["Configure description"] = "Vous permet de configurer la fenêtre de Skada active."
...
L["Delete theme"] = "Suppression d'un thème"
...
L["Report"] = "Rapport"
L["Report description"] = "Ouvre une boîte de dialogue vous permettant de rapporter vos données aux autres joueurs de multiples façons."
L["reports the active mode"] = "fait un rapport du mode actif"
L["Reset"] = "Réinitialiser"
L["Reset description"] = "Réinitialise toutes les données de combat à l'exception de ceux marqués comme devant être gardés."
...
-- L["Runic power gained"] = ""
-- L["Runic power gain sources"] = ""
L["'s "] = " : "
L["'s Absorbs"] = " : absorptions"
L["Save"] = "Sauvegarder"
L["Save theme"] = "Sauvegarde d'un thème"
L["Say"] = "Dire"
L["'s Buffs"] = " : buffs"
L["Scale"] = "Échelle"
L["'s Damage"] = " : dégâts"
...
L["Use role icons where applicable."] = "Utilise les icônes de rôle quand cela est possible."
-- L["Various tweaks to get around deficiences and problems in the game's combat logs. Carries a small performance penalty."] = ""
