...
--[[ 		if self.db.separateEnergy and R.myclass == "ROGUE" then
	...
	if unit == "target" then
		...
		castbar.Icon:Hide()
		castbar.Iconbg:Hide()
		R:CreateMover(castbar, "TargetCastBarMover", L["目标施法条锚点"], true, nil, "ALL,RAID15,RAID25,RAID40")
		frame.Castbar = castbar
	...
	if unit == "focus" then
		...
		R:CreateMover(castbar, "FocusCastBarMover", L["焦点施法条锚点"], true, nil, "ALL,RAID15,RAID25,RAID40")
		frame.Castbar = castbar
