...
local frame = UICreateInterfaceOptionPage("PetCouncilMainFrame", L["title"], nil, nil, PetJournal)
addon.frame = frame
...
local list = UICreateVirtualScrollList(frame:GetName().."List", frame, 8, 1)
addon.teamList = list
