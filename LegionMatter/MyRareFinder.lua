...
function MyRareFinderDraw( frame, type, n, x, y, npcid, npcnote )
	...
	if ( f.raretype == 1 ) then
		if ( MyRareFinderOneTimeRares == true ) then
			f:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIcon.tga")
		else
			f:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconNone.tga")
			f:SetWidth(0)
			f:SetHeight(0)
		end
	elseif ( f.raretype == 2 ) then
		if ( MyRareFinderKilledOTRares == true ) then
			f:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconDead.tga")
		else
			f:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconNone.tga")
			f:SetWidth(0)
			f:SetHeight(0)
	...
	elseif ( f.raretype == 3 ) then
		if ( MyRareFinderNormalRares == true ) then
			f:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconRed.tga")
		else
			f:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconNone.tga")
			f:SetWidth(0)
			f:SetHeight(0)
	...
	elseif ( f.raretype == 4 ) then
		if ( MyRareFinderDailyRares == true ) then
			f:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconBlue.tga")
		else
			f:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconNone.tga")
			f:SetWidth(0)
			f:SetHeight(0)
	...
	f:SetScript("OnShow", function(self)
			...
			if ( self.raretype == 1 ) then
				if ( MyRareFinderOneTimeRares == true ) then
					self:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIcon.tga")
					self:SetWidth(16)
					self:SetHeight(16)
				else
					self:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconNone.tga")
					self:SetWidth(0)
					self:SetHeight(0)
				end
			elseif ( self.raretype == 2 ) then
				if ( MyRareFinderKilledOTRares == true ) then
					self:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconDead.tga")
					self:SetWidth(16)
					self:SetHeight(16)
				else
					self:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconNone.tga")
			...
			elseif ( self.raretype == 3 ) then
				if ( MyRareFinderNormalRares == true ) then
					self:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconRed.tga")
					self:SetWidth(16)
					self:SetHeight(16)
				else
					self:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconNone.tga")
			...
			elseif ( self.raretype == 4 ) then
				if ( MyRareFinderDailyRares == true ) then
					self:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconBlue.tga")
					self:SetWidth(16)
					self:SetHeight(16)
				else
					self:SetNormalTexture("Interface\\AddOns\\DraenorMatter\\textures\\RareIconNone.tga")
